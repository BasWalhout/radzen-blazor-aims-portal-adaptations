...
namespace Radzen.Blazor
{
    ...
    /// </summary>
    public partial class RadzenTreePanelMenuItem : RadzenComponent
    {
        /// <inheritdoc />
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="RadzenTreePanelMenuItem"/> is expanded.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="RadzenTreePanelMenuItem"/> is selected.
        /// </summary>
        ...
        internal async Task Toggle()
        {
            ...
            {
                var itemsToSkip = new List<RadzenTreePanelMenuItem>();
        ...
        [CascadingParameter]
        public RadzenTreePanelMenuItem ParentItem { get; set; }
        ...
        [CascadingParameter]
        public RadzenTreePanelMenu Parent { get; set; }
        ...
        string LinkClass => ClassList.Create("rz-navigation-item-link")
            ...
            .Add("rz-state-focused", Parent?.IsFocused(this, false) == true)
            .ToString();

        string ToggleWrapperClass => ClassList.Create("rz-tree-panel-menu-item-toggle-wrapper")
            .Add("rz-state-focused", Parent?.IsFocused(this, true) == true)
            .ToString();
