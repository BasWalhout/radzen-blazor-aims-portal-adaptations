...
namespace Radzen.Blazor
{
    ...
    public class RadzenRadioCardListItem<TValue> : RadzenComponent
    {
        /// <summary>
        ...
        [Parameter]
        public RenderFragment<RadzenRadioCardListItem<TValue>> Template { get; set; }
        ...
        RadzenRadioCardList<TValue> _list;
        ...
        [CascadingParameter]
        public RadzenRadioCardList<TValue> List
        {
            get
            {
                return _list;
